    ...
    <>
      ...
      <Box sx={{ bgcolor: '#f7f7f7', py: { xs: 6, md: 8 } }}>
        <Container maxWidth="lg">
          ...
          >
            {/* Render the first three features */}
              ...
              <Box key={index} sx={{ height: '100%' }}>
                ...
                >
                  ...
                  {feature.actionText && (
                    <Button
                      variant="contained"
                      sx={{ bgcolor: feature.color, color: 'white', fontWeight: 'bold', mt: 2, '&:hover': { bgcolor: feature.color } }}
                      onClick={feature.action}
                      href={feature.href}
                      component={feature.href ? Link : 'button'}
                    >
                      {feature.actionText}
                    </Button>
                  )}
            ...
            {/* Insert Object Detection Card in the grid */}
            <Box sx={{ height: '100%' }}>
              <Card
                sx={{
                  height: '100%',
              ...
              >
                <h2>Waste Detection & Reuse System</h2>
                <p>Detect waste and get eco-friendly reuse suggestions with AI.</p>
                <Link href="/waste-detection" passHref>
                  <button
                    style={{
                      background: '#388e3c',
                      color: 'white',
            ...
            {/* Render the remaining features */}
            {features.slice(3).map((feature, index) => (
              <Box key={index + 3} sx={{ height: '100%' }}>
                <Card
                  sx={{
                    height: '100%',
                    minHeight: 320,
